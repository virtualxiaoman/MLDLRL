...
| 代码 | 描述 | 模型 | score |
| --- | --- | --- | --- |
| [D_HP_1_quick_start.py](https://github.com/virtualxiaoman/Easier_DataScience/blob/master/data_analyse/ML_HUB/Demo_House_Prices/D_HP_1_quick_start.py) | 快速开始 | `lgb`+`KFold` | 0.40853 |
| [D_HP_2_data_preprocessing.ipynb](https://github.com/virtualxiaoman/Easier_DataScience/blob/master/data_analyse/ML_HUB/Demo_House_Prices/D_HP_2_EDA.ipynb) | 数据预处理 | `train['SalePrice'].mean()` | 0.42577 |
