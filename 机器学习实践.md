...
## 1.3 California House Prices

[数据集](https://www.kaggle.com/c/california-house-prices/overview) ，这是d2l的竞赛，在沐神的[10行代码战胜90%数据科学家？](https://www.bilibili.com/video/BV1rh411m7Hb)中讲解。


注意：添加数据集时`california-house-prices`有多个结果，选择李沐的那一个：

<div style="display: flex; justify-content: center; align-items: center;">
    <div style="text-align: center;">
        <img src="assets/机器学习实践/images/image-8.png" style="width: 30%;"/>
        <p style="font-size: small; color: gray;">可以点那个箭头看是不是李沐的</p>
    </div>
</div>
